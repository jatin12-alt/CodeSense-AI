            ...
            {reposLoading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                {Array.from({ length: 6 }).map((_, i) => (
                  <div
                    key={i}
                    className="rounded-2xl border border-[rgba(255,255,255,0.07)] bg-[#0f1520] p-5 animate-pulse"
                  >
                    <div className="h-4 w-1/2 bg-[rgba(255,255,255,0.07)] rounded" />
                    <div className="h-3 w-1/3 bg-[rgba(255,255,255,0.07)] rounded mt-3" />
                    <div className="h-3 w-2/3 bg-[rgba(255,255,255,0.07)] rounded mt-6" />
                  </div>
                ))}
              </div>
            ) : repos.length === 0 ? (
              <div className="rounded-3xl border border-[rgba(255,255,255,0.07)] bg-[#0f1520] p-10 text-center">
                <div className="inline-flex items-center gap-2 border border-[rgba(0,229,160,0.25)] text-[#00e5a0] text-[10px] tracking-[2px] uppercase px-3 py-1.5 rounded-full bg-[rgba(0,229,160,0.06)] font-mono w-fit mx-auto">
                  GET STARTED
                </div>
                <h2 className="font-display font-bold text-2xl mt-4">
                  Index your first repository
                </h2>
                <p className="font-mono text-sm text-[#6b7a8d] mt-2 max-w-xl mx-auto">
                  Add a GitHub repo URL to build embeddings and unlock chat, reviews, and code health insights.
                </p>
                <button
                  onClick={() => setIsModalOpen(true)}
                  disabled={!canInteract}
                  className="mt-6 font-mono text-sm px-5 py-3 rounded-xl border border-[rgba(0,229,160,0.25)] bg-[rgba(0,229,160,0.08)] text-[#00e5a0] hover:bg-[rgba(0,229,160,0.12)] transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Add New Repo
                </button>
              </div>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="font-mono text-xs px-2.5 py-1 rounded-lg border border-[rgba(255,255,255,0.07)] text-[#6b7a8d] hover:text-white hover:border-[rgba(255,255,255,0.18)] transition"
                            title="Delete repo"
                          >
                            Delete
                          </button>
